...
export default function Photoshop() {
  return (
    <svg preserveAspectRatio="xMidYMid meet" focusable="false" aria-hidden="true" role="presentation" viewBox="0 0 240 234"><path fill="#001D26" d="M10,10h220v214H10V10z"></path><path fill="#00C8FF" d="M0,0v234h240V0H0z M10,10h220v214H10V10z M58,54.8c0-0.7,1.4-1.2,2.2-1.2c6.4-0.3,15.9-0.5,25.8-0.5
        ...
        c0.8,0.5,1,1.3,1,2v13.7c0,0.8-0.5,1.3-1.5,1C174.8,97.7,168.3,96,161.8,96L161.8,96z"></path>
    </svg>
  )
}
